...
public final class AuthServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<AuthServiceProto.TokenRequest,
      AuthServiceProto.TokenResponse> getValidateTokenMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ValidateToken",
      requestType = AuthServiceProto.TokenRequest.class,
      responseType = AuthServiceProto.TokenResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<AuthServiceProto.TokenRequest,
      AuthServiceProto.TokenResponse> getValidateTokenMethod() {
    io.grpc.MethodDescriptor<AuthServiceProto.TokenRequest, AuthServiceProto.TokenResponse> getValidateTokenMethod;
      ...
      synchronized (AuthServiceGrpc.class) {
        if ((getValidateTokenMethod = AuthServiceGrpc.getValidateTokenMethod) == null) {
          AuthServiceGrpc.getValidateTokenMethod = getValidateTokenMethod =
              io.grpc.MethodDescriptor.<AuthServiceProto.TokenRequest, AuthServiceProto.TokenResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ValidateToken"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AuthServiceProto.TokenRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AuthServiceProto.TokenResponse.getDefaultInstance()))
  ...
  public static final class AuthServiceBlockingStub
    ...
    /**
     */
    public AuthServiceProto.TokenResponse validateToken(AuthServiceProto.TokenRequest request) {
  ...
  public static final class AuthServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<AuthServiceProto.TokenResponse> validateToken(
        AuthServiceProto.TokenRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_VALIDATE_TOKEN:
          serviceImpl.validateToken((AuthServiceProto.TokenRequest) request,
              (io.grpc.stub.StreamObserver<AuthServiceProto.TokenResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              AuthServiceProto.TokenRequest,
              AuthServiceProto.TokenResponse>(
